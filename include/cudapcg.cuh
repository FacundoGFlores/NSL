...
Version     : 	0.1
Description : 	This is the pre conditionated conjugate gradient method using CUDA and cuBlas.
License     :
 ...
 */
long cuda_PCG(const linearMatrix &Matrix_A, const linearMatrix &Matrix_M, const linearMatrix &Vector_B, linearMatrix &Vector_X,
